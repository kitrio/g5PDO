    ...
    <div class="reg-form sns-wrap-reg">
        <div class="sns-wrap">
            ...
            <?php foreach ($socials as $social => $provider_name) {
                ...
                <a href="<?php echo $link_href; ?>" id="sns-<?php echo $social; ?>"
                   class="sns-icon social_link sns-<?php echo $social; ?><?php echo $add_class; ?>"
                   title="<?php echo $title; ?>" data-provider="<?php echo $social; ?>"><span class="ico"></span><span
                            class="txt"><?php echo $provider_name; ?> 로그인</span></a>
