...
$board_skin_url     = get_skin_url_from_path($board_skin_path);
$member_skin_url    = get_skin_url_from_path($member_skin_path);
$new_skin_url       = get_skin_url_from_path($new_skin_path);
$search_skin_url    = get_skin_url_from_path($search_skin_path);
$connect_skin_url   = get_skin_url_from_path($connect_skin_path);
$faq_skin_url       = get_skin_url_from_path($faq_skin_path);
//==============================================================================
