...
DoUpload.prototype = {
  ...
  imageResize: function (image, filetype, resize_w, orientation, addWaterMark) {
    ...
    if (orientation > 0 && !supportImageOrientation) {
      ...
      switch (orientation) {
        case 2 :
          ctx.transform(-1, 0, 0, 1, source_w, 0);
          break;
        case 3 :
          ctx.transform(-1, 0, 0, -1, source_w, source_h);
          break;
        case 4 :
          ctx.transform(1, 0, 0, -1, 0, source_h);
          break;
        case 5 :
          ctx.transform(0, 1, 1, 0, 0, 0);
          break;
        case 6 :
          ctx.transform(0, 1, -1, 0, source_h, 0);
          break;
        case 7 :
          ctx.transform(0, -1, -1, 0, source_h, source_w);
          break;
        case 8 :
          ctx.transform(0, -1, 1, 0, 0, source_w);
          break;
        default:
          break;
      }
