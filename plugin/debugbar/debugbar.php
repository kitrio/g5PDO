...
<div class="debug_bar_wrap">
    ...
    <div class="debug_bar_content">
        <div class="content_inner">
            ...
            <div class="debugbar_close_btn_el">
                <button class="debugbar_close_btn btn">닫기</button>
            </div>
            <div id="debugbar">
                <ul class="debugbar_tab">
                    <li class="debug_tab active" data-tab="executed_query"><a href="#debug_executed_query">SQL Query</a>
                    </li>
                                ...
                                if (isset($event_callbacks[$tag])) {
                                    ...
                                    foreach ($datas as $data) {
                                        ...
                                        <tr>
                                            <?php if ($is_print) { ?>
                                                <td scope="row"
                                                    data-label="event_tag" <?php echo $rowspan; ?>><?php echo $tag . ' <span class="hook_count">(' . $count . ')</span>'; ?></td>
                                            <?php } ?>
                                    ...
                                    <tr>
                                        <td scope="row"
                                            data-label="event_tag"><?php echo $tag . ' <span class="hook_count">(' . $count . ')</span>'; ?></td>
                                ...
                                if (isset($replace_callbacks[$tag])) {
                                    ...
                                    foreach ($datas as $data) {
                                        ...
                                        <tr>
                                            <?php if ($is_print) { ?>
                                                <td scope="row"
                                                    data-label="replace_tag" <?php echo $rowspan; ?>><?php echo $tag . ' <span class="hook_count">(' . $count . ')</span>'; ?></td>
                                            <?php } ?>
                                    ...
                                    <tr>
                                        <td scope="row"
                                            data-label="replace_tag"><?php echo $tag . ' <span class="hook_count">(' . $count . ')</span>'; ?></td>
