...
<head>
    ...
    <script language="javascript" src="https://xpay.tosspayments.com/xpay/js/xpay_crossplatform.js"
...
<div id="uplus_win" class="new_win mbskin">
    ...
    <div class="up_info">
        <a href="http://pgweb.uplus.co.kr:8080/pg/wmp/Home2009/skill/payment_error_center01.jsp" target="_blank"><img
                    src="<?php echo G5_LGXPAY_URL; ?>/img/btn_gouplus.jpg" alt="U+ 오류 해결방법 바로가기"></a>
