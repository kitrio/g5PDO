            ...
            <ul>
                <li>
                    ...
                    <input type="text" name="is_subject" value="<?php echo get_text($use['is_subject']); ?>"
                           id="is_subject" required class="required frm_input" minlength="2" maxlength="250"
                           placeholder="제목">
                </li>
                <li>
                    ...
                    <ul id="sit_use_write_star">
                        <li>
                            <input type="radio" name="is_score" value="5"
                                   id="is_score10" <?php echo ($is_score == 5) ? 'checked="checked"' : ''; ?>>
                        ...
                        <li>
                            <input type="radio" name="is_score" value="4"
                                   id="is_score8" <?php echo ($is_score == 4) ? 'checked="checked"' : ''; ?>>
                        ...
                        <li>
                            <input type="radio" name="is_score" value="3"
                                   id="is_score6" <?php echo ($is_score == 3) ? 'checked="checked"' : ''; ?>>
                        ...
                        <li>
                            <input type="radio" name="is_score" value="2"
                                   id="is_score4" <?php echo ($is_score == 2) ? 'checked="checked"' : ''; ?>>
                        ...
                        <li>
                            <input type="radio" name="is_score" value="1"
                                   id="is_score2" <?php echo ($is_score == 1) ? 'checked="checked"' : ''; ?>>
