...
<form name="fitem" action="<?php echo $action_url; ?>" method="post" onsubmit="return fitem_submit(this);">
    ...
    <div id="sit_tab">
        <ul class="tab_tit">
            ...
            <li>
                <button type="button" id="btn_sit_use" rel="#sit_use">사용후기</button>
            </li>
            <li>
                <button type="button" id="btn_sit_qa" rel="#sit_qa">상품문의</button>
            </li>
            <li>
                <button type="button" id="btn_sit_dvex" rel="#sit_dvex">배송/교환</button>
            </li>
        </ul>
        <ul class="tab_con">
