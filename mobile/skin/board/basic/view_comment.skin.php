    ...
    <section id="bo_vc">
        ...
        for ($i = 0; $i < count($list); $i++) {
            ...
            <article id="c_<?php echo $comment_id ?>"
                     <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-bottom-color:#f8f8f8"<?php } ?>>
                <div class="comment_inner">
                    <header>
                        <h2><?php echo get_text($list[$i]['wr_name']); ?>님의 댓글<?php if ($cmt_depth) { ?><span
                                    class="sound_only">의 댓글</span><?php } ?></h2>
                        ...
                        <?php if ($is_comment_reply_edit) { ?>
                            <div class="bo_vl_opt">
                                <button type="button" class="btn_cm_opt btn_b03 btn"><i class="fa fa-ellipsis-v"
                    ...
                    <input type="hidden" id="secret_comment_<?php echo $comment_id ?>"
                           value="<?php echo strstr($list[$i]['wr_option'], "secret") ?>">
...
<?php if ($is_comment_write) {
    ...
    <aside id="bo_vc_w">
        ...
        <form name="fviewcomment" id="fviewcomment" action="<?php echo $comment_action_url; ?>"
              onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off" class="bo_vc_w">
