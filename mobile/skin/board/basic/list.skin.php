...
<form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php"
    ...
    <?php if ($rss_href || $write_href) { ?>
        <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top top btn_bo_user'; ?>">
            ...
            <?php if ($rss_href) { ?>
                <li><a href="<?php echo $rss_href ?>" class="btn_b03 btn" title="RSS"><i class="fa fa-rss"
            ...
            <?php } ?>
            <?php if ($write_href) { ?>
                <li><a href="<?php echo $write_href ?>" class="fix_btn write_btn" title="글쓰기"><i class="fa fa-pencil"
                                                                                                 aria-hidden="true"></i><span
                ...
                <?php for ($i = 0; $i < count($list); $i++) { ?>
                    <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                        ...
                        <div class="bo_cnt">
                            <?php if ($list[$i]['is_notice'] || ($is_category && $list[$i]['ca_name'])) { ?>
                                <div class="bo_cate_ico">
                                    <?php if ($list[$i]['is_notice']) { ?><strong
                                            class="notice_icon">공지</strong><?php } ?>
                        ...
                        <div class="bo_info">
                            ...
                            <span class="bo_view"><i class="fa fa-eye"
                                                     aria-hidden="true"></i> <?php echo number_format($list[$i]['wr_hit']) ?><span
                                        class="sound_only">회</span></span>
