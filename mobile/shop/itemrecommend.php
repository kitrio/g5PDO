...
?>
    ...
    <div id="sit_rec_new" class="new_win">
        ...
        <form name="fitemrecommend" method="post" action="./itemrecommendmail.php" autocomplete="off"
            ...
            <div class="new_win_con form_01">
                <ul>
                    <li>
                        ...
                        <input type="email" name="to_email" id="to_email" required class="frm_input full_input"
                               placeholder="추천받는 분 E-mail">
                    </li>
                    <li>
                        <label for="subject" class="sound_only">제목</label>
                        <input type="text" name="subject" id="subject" required class="frm_input full_input"
                               placeholder="제목">
                    </li>
                    <li>
