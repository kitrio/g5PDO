                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <li class="sod_li">
                        ...
                        <div class="li_op_wr">
                            <div class="li_chk chk_box">
                                <input type="checkbox" name="ct_chk[<?php echo $i; ?>]" value="1"
                                       id="ct_chk_<?php echo $i; ?>" class="selec_chk" checked>
                                <label for="ct_chk_<?php echo $i; ?>"><span></span><b
                        ...
                        <div class="total_price total_span">
                            <span>소계 </span><strong><?php echo number_format($sell_price); ?></strong>원
                        </div>
                    </li>
            ...
            <?php } else { ?>
                <div class="sod_ta_wr">
                    ...
                    <div id="sod_bsk_act" class="btn_confirm">
                        <div class="total">총계 <strong class="total_cnt"><?php echo number_format($tot_price); ?>
                                원</strong></div>
