        ...
        <ul>
            ...
            for ($i = 0; $row = sql_fetch_array($result); $i++) {
                ...
                <li>
                    ...
                    <div>
                        <span class="cou_target"><?php echo $cp_target; ?> <i class="fa fa-angle-right"
                                                                              aria-hidden="true"></i></span>
                        <span class="cou_date"><i class="fa fa-clock-o"
                                                  aria-hidden="true"></i> <?php echo substr($row['cp_start'], 2, 8); ?> ~ <i
                                    class="fa fa-clock-o"
                                    aria-hidden="true"></i> <?php echo substr($row['cp_end'], 2, 8); ?></span>
                    </div>
                </li>
                <?php
            }
