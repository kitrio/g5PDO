...
?>
    ...
    <div id="smb_my">
        ...
        <section id="smb_my_ov">
            ...
            <ul class="my_pocou">
                ...
                <li class="my_point">
                    ...
                    <a href="<?php echo G5_BBS_URL; ?>/point.php" target="_blank"
                       class="win_point"><?php echo number_format($member['mb_point']); ?>점</a>
                </li>
            </ul>
            <div class="my_info">
            ...
            <div class="my_ov_btn">
                <button type="button" class="btn_op_area"><i class="fa fa-caret-down" aria-hidden="true"></i><span
