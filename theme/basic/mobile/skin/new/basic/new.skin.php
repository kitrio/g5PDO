...
<fieldset id="new_sch">
    ...
    <form name="fnew" method="get">
        ...
        <div class="ipt_sch">
            ...
            <input type="text" name="mb_id" value="<?php echo $mb_id ?>" id="mb_id" placeholder="검색어를 입력하세요" required
                   class="frm_input">
        ...
        for ($i = 0; $i < count($list); $i++) {
            ...
            <li>
                <a href="<?php echo get_pretty_url($list[$i]['bo_table']); ?>"
                   class="new_board"><?php echo $bo_subject ?></a>
                <a href="<?php echo $list[$i]['href'] ?>"
                   class="new_tit"><?php echo $list[$i]['comment'] ?><?php echo $wr_subject ?></a>
                <div class="new_info">
