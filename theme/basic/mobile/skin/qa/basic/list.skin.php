...
<form name="fqalist" id="fqalist" action="./qadelete.php" onsubmit="return fqalist_submit(this);" method="post">
    ...
    <?php if ($admin_href || $write_href) { ?>
        <ul class="btn_top top btn_bo_user">
            <?php if ($admin_href) { ?>
                <li><a href="<?php echo $admin_href ?>" class="btn_admin btn"><i
                            class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a></li><?php } ?>
            <?php if ($is_admin == 'super' || $is_auth) { ?>
                <li>
                    <button type="button" class="btn_more_opt btn_b03 btn"><i class="fa fa-ellipsis-v"
            ...
            <?php } ?>
            <?php if ($write_href) { ?>
                <li><a href="<?php echo $write_href ?>" class="fix_btn"><i class="fa fa-pencil"
                                                                           aria-hidden="true"></i><span
                ...
                for ($i = 0; $i < count($list); $i++) {
                    ...
                    <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                        ...
                        <div class="li_info">
                            ...
                            <span class="bo_date"><i class="fa fa-clock-o"
                                                     aria-hidden="true"></i> <?php echo $list[$i]['date']; ?></span>
...
<fieldset id="bo_sch">
    ...
    <form name="fsearch" method="get">
        ...
        <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required placeholder="검색어를 입력하세요"
               id="stx" class="sch_input" size="15" maxlength="15">
