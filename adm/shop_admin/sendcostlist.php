...
?>
    ...
    <section id="scp_list">
        ...
        <form name="fsendcost" id="fsendcost" method="post" action="./sendcostupdate.php"
              onsubmit="return fsendcost_submit(this);">
                ...
                <table>
                    ...
                    for ($i = 0; $row = sql_fetch_array($result); $i++) {
                        ...
                        <tr class="<?php echo $bg; ?>">
                            <td class="td_chk">
                                <input type="hidden" id="sc_id_<?php echo $i; ?>" name="sc_id[<?php echo $i; ?>]"
            ...
            <div class="tbl_frm01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="sc_name" value="" id="sc_name" class="required frm_input" size="30"
                                   required></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="sc_zip1">우편번호 시작<strong class="sound_only">필수</strong></label></th>
                        <td>
                            <input type="text" name="sc_zip1" id="sc_zip1" required class="required frm_input"
                                   size="10"> (입력 예 : 01234)
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="sc_zip2" id="sc_zip2" required class="required frm_input"
                                   size="10"> (입력 예 : 01234)
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="sc_price">추가배송비<strong class="sound_only">필수</strong></label></th>
                        <td><input type="text" name="sc_price" id="sc_price" size="8" required
                                   class="required frm_input"> 원
                        </td>
                    </tr>
                    </tbody>
                </table>
