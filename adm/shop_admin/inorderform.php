...
?>
    ...
    <section id="anc_sodr_list">
        ...
        <div class="local_desc02 local_desc">
            <p>
                주문일시 <strong><?php echo substr($od['dt_time'], 0, 16); ?> (<?php echo get_yoil($od['dt_time']); ?>
                    )</strong>
                |
    ...
    <section id="anc_sodr_pay">
        ...
        <div class="tbl_head01 tbl_wrap">
            <form name="frmorderform" method="post" action="./inorderformupdate.php"
                    ...
                    <table>
                        ...
                        <?php if ($default['de_hope_date_use']) { ?>
                            <tr>
                                ...
                                <td><?php echo $data['od_hope_date']; ?> (<?php echo get_yoil($data['od_hope_date']); ?>
                                    )
                                </td>
                            </tr>
                        <?php } ?>
