        ...
        <div class="tbl_head01 tbl_wrap">
            <table>
                ...
                <tr>
                    ...
                    <th scope="col" rowspan="3"><?php echo subject_sort_link('it_soldout', 'sca=' . $sca, 1); ?>
                        품절</a></th>
                ...
                <tr>
                    ...
                    <th scope="col" rowspan="2"
                        id="th_pc_title"><?php echo subject_sort_link('it_name', 'sca=' . $sca); ?>상품명</a></th>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td colspan="5" class="td_sort">
                            <label for="ca_id_<?php echo $i; ?>"
                                   class="sound_only"><?php echo get_text($row['it_name']); ?> 기본분류</label>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        <td rowspan="2" class="td_img"><a
                                    href="<?php echo $href; ?>"><?php echo get_it_image($row['it_id'], 50, 50); ?></a>
                        </td>
                        ...
                        <td headers="th_amt" class="td_numbig td_input">
                            ...
                            <input type="text" name="it_price[<?php echo $i; ?>]"
                                   ...
                                   class="tbl_input sit_amt" size="7">
                        </td>
