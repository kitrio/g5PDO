...
?>
    ...
    <form name="fpersonalpayform" action="./personalpayformupdate.php" method="post"
            ...
            <div class="tbl_frm01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="pp_name" value="<?php echo get_text($pp['pp_name']); ?>"
                                   id="pp_name" required class="required frm_input"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="pp_price">주문금액</label></th>
                        <td><input type="text" name="pp_price" value="<?php echo $pp['pp_price']; ?>" id="pp_price"
                                   required class="required frm_input" size="15"> 원
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="od_id">주문번호</label></th>
                        <td><input type="text" name="od_id" value="<?php echo $pp['od_id'] ? $pp['od_id'] : ''; ?>"
                                   id="od_id" class="frm_input" size="20"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="pp_content">내용</label></th>
                        <td><textarea name="pp_content" id="pp_content"
                                      rows="8"><?php echo html_purifier($pp['pp_content']); ?></textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="tbl_frm01 tbl_wrap">
                    <table>
                        ...
                        <?php if ($popup != 'yes') { ?>
                            <tr>
                                ...
                                <td><input type="text" name="pp_receipt_price"
                                           value="<?php echo $pp['pp_receipt_price'] ? $pp['pp_receipt_price'] : ''; ?>"
                                           id="pp_receipt_price" class="frm_input" size="15"> 원
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="pp_settle_case" id="pp_settle_case">
                                        <option value="" <?php echo get_selected($pp['pp_settle_case'], ''); ?>>선택
                                        </option>
                                        <option value="무통장" <?php echo get_selected($pp['pp_settle_case'], '무통장'); ?>>
                                            무통장
                                        </option>
                                        <option value="계좌이체" <?php echo get_selected($pp['pp_settle_case'], '계좌이체'); ?>>
                                            계좌이체
                                        </option>
                                        <option value="가상계좌" <?php echo get_selected($pp['pp_settle_case'], '가상계좌'); ?>>
                                            가상계좌
                                        </option>
                                        <option value="신용카드" <?php echo get_selected($pp['pp_settle_case'], '신용카드'); ?>>
                                            신용카드
                                        </option>
                                        <option value="휴대폰" <?php echo get_selected($pp['pp_settle_case'], '휴대폰'); ?>>
                                            휴대폰
                                        </option>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="pp_receipt_chk" id="pp_receipt_chk"
                                    ...
                                    <input type="text" name="pp_receipt_time"
                                           value="<?php echo is_null_time($pp['pp_receipt_time']) ? "" : $pp['pp_receipt_time']; ?>"
                                ...
                                if ($pp['pp_receipt_price'] && ($pp['pp_settle_case'] == '무통장' || $pp['pp_settle_case'] == '가상계좌' || $pp['pp_settle_case'] == '계좌이체')) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <a href="javascript:;"
                                                   onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?tx=personalpay&od_id=<?php echo $pp_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');">현금영수증
                                                    발급</a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="pp_shop_memo" id="pp_shop_memo"
                                          rows="8"><?php echo html_purifier($pp['pp_shop_memo']); ?></textarea></td>
                        </tr>
                        <tr>
        ...
        <div class="<?php echo $btn_class; ?>">
            ...
            <?php } ?>
            <?php if ($w == 'u') { ?>
                <a href="./personalpayformupdate.php?w=d&amp;pp_id=<?php echo $pp['pp_id']; ?>"
