                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_type1_list_use" value="1"
                                   id="de_type1_list_use" <?php echo $default['de_type1_list_use'] ? "checked" : ""; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_type2_list_use" value="1"
                                   id="de_type2_list_use" <?php echo $default['de_type2_list_use'] ? "checked" : ""; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_type3_list_use" value="1"
                                   id="de_type3_list_use" <?php echo $default['de_type3_list_use'] ? "checked" : ""; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_type4_list_use" value="1"
                                   id="de_type4_list_use" <?php echo $default['de_type4_list_use'] ? "checked" : ""; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_type5_list_use" value="1"
                                   id="de_type5_list_use" <?php echo $default['de_type5_list_use'] ? "checked" : ""; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="de_mobile_type2_list_use">출력</label> <input type="checkbox"
                                                                                    name="de_mobile_type2_list_use"
                                                                                    value="1"
                                                                                    id="de_mobile_type2_list_use" <?php echo $default['de_mobile_type2_list_use'] ? "checked" : ""; ?>>
                ...
                <table>
                    ...
                    <tr id="de_taxsave_types" class="de_taxsave_types">
                        ...
                        <td>
                            ...
                            <input type="checkbox" id="de_taxsave_types_account" name="de_taxsave_types_account"
                                   value="account" <?php echo $account_checked; ?> > <label
                                    for="de_taxsave_types_account" disabled>무통장입금</label><br>
                            <input type="checkbox" id="de_taxsave_types_vbank" name="de_taxsave_types_vbank"
                                   value="vbank" <?php echo $vbank_checked; ?> > <label for="de_taxsave_types_vbank">가상계좌</label><br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="cf_use_point" value="1"
                                   id="cf_use_point"<?php echo $config['cf_use_point'] ? ' checked' : ''; ?>> 사용
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            주문 완료 <input type="text" name="de_point_days"
                                         value="<?php echo get_sanitize_input($default['de_point_days']); ?>"
                                         id="de_point_days" class="frm_input" size="2"> 일 이후에 포인트를 지급
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="de_pg_tab">
                                <li class="<?php if ($default['de_pg_service'] == 'kcp') echo 'tab-current'; ?>"><a
                                            href="#kcp_info_anchor" data-value="kcp" title="NHN KCP 선택하기">NHN KCP</a>
                                </li>
                                <li class="<?php if ($default['de_pg_service'] == 'lg') echo 'tab-current'; ?>"><a
                                            href="#lg_info_anchor" data-value="lg"
                                            title="토스페이먼츠(구버전) 선택하기">토스페이먼츠(구버전)</a></li>
                                <li class="<?php if ($default['de_pg_service'] == 'toss') echo 'tab-current'; ?>"><a
                                            href="#lg_info_anchor" data-value="toss" title="토스페이먼츠 선택하기">토스페이먼츠</a></li>
                                <li class="<?php if ($default['de_pg_service'] == 'inicis') echo 'tab-current'; ?>"><a
                                            href="#inicis_info_anchor" data-value="inicis"
                                            title="KG이니시스 선택하기">KG이니시스</a></li>
                                <li class="<?php if ($default['de_pg_service'] == 'nicepay') echo 'tab-current'; ?>"><a
                                            href="#nicepay_info_anchor" data-value="nicepay" title="NICEPAY 선택하기">NICEPAY</a>
                                </li>
                            </ul>
                        </td>
                    </tr>
                    <tr class="pg_info_fld kcp_info_fld" id="kcp_info_anchor">
                        ...
                        <td>
                            ...
                            <span class="sitecode">SR</span> <input type="text" name="de_kcp_mid"
                                                                    value="<?php echo get_sanitize_input($default['de_kcp_mid']); ?>"
                                                                    id="de_kcp_mid" class="frm_input code_input"
                                                                    size="2" maxlength="3"> 영대문자, 숫자 혼용 3자리
                        </td>
                    </tr>
                    ...
                    <tr class="pg_info_fld kcp_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" id="de_easy_nhnkcp_payco" name="de_easy_pays[]"
                                   value="nhnkcp_payco" <?php if (stripos($default['de_easy_pay_services'], 'nhnkcp_payco') !== false) {
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nhnkcp_payco" disabled>PAYCO (페이코)</label><br>
                            <input type="checkbox" id="de_easy_nhnkcp_naverpay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nhnkcp_naverpay">NAVERPAY (네이버페이)</label><br>
                            <input type="checkbox" id="de_easy_nhnkcp_kakaopay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nhnkcp_kakaopay">KAKAOPAY (카카오페이)</label><br>
                            <input type="checkbox" id="de_easy_nhnkcp_applepay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nhnkcp_applepay">APPLEPAY (애플페이)</label>
                        </td>
                    </tr>
                    <tr class="pg_info_fld kcp_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" id="de_global_nhnkcp_naverpay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_global_nhnkcp_naverpay">NAVERPAY (네이버페이)</label><br>
                        </td>
                    </tr>
                    <tr class="pg_info_fld kcp_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" id="used_nhnkcp_naverpay_point" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="used_nhnkcp_naverpay_point">NAVERPAY POINT (네이버페이 포인트 사용)</label><br>
                        </td>
                    </tr>
                    <tr class="pg_info_fld lg_info_fld" id="lg_info_anchor">
                        ...
                        <td>
                            ...
                            <span class="sitecode">si_</span> <input type="text" name="cf_lg_mid"
                                                                     value="<?php echo get_sanitize_input($config['cf_lg_mid']); ?>"
                                                                     id="cf_lg_mid" class="frm_input code_input"
                                                                     size="10" maxlength="20"> 영문자, 숫자 혼용
                        </td>
                    </tr>
                    <tr class="pg_info_fld lg_info_fld">
                        ...
                        <td>
                            ...
                            <input type="text" name="cf_lg_mert_key"
                                   value="<?php echo get_sanitize_input($config['cf_lg_mert_key']); ?>"
                                   id="cf_lg_mert_key" class="frm_input " size="36" maxlength="50">
                        </td>
                    </tr>
                    ...
                    <tr class="pg_info_fld inicis_info_fld" id="inicis_info_anchor">
                        ...
                        <td>
                            ...
                            <span class="sitecode">SIR</span> <input type="text" name="de_inicis_mid"
                                                                     value="<?php echo $default['de_inicis_mid']; ?>"
                                                                     id="de_inicis_mid" class="frm_input code_input"
                                                                     size="10" maxlength="10"> 영문소문자(숫자포함 가능)
                        </td>
                    </tr>
                    ...
                    <tr class="pg_info_fld inicis_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_samsung_pay_use" value="1"
                                   id="de_samsung_pay_use"<?php echo $default['de_samsung_pay_use'] ? ' checked' : ''; ?>>
                    ...
                    <tr class="pg_info_fld inicis_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_inicis_lpay_use" value="1"
                                   id="de_inicis_lpay_use"<?php echo $default['de_inicis_lpay_use'] ? ' checked' : ''; ?>>
                    ...
                    <tr class="pg_info_fld inicis_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_inicis_kakaopay_use" value="1"
                                   id="de_inicis_kakaopay_use"<?php echo $default['de_inicis_kakaopay_use'] ? ' checked' : ''; ?>>
                            <label for="de_inicis_kakaopay_use">사용</label>
                        </td>
                    </tr>
                    <tr class="pg_info_fld inicis_info_fld">
                        <th scope="row">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_inicis_cartpoint_use" value="1"
                                   id="de_inicis_cartpoint_use"<?php echo $default['de_inicis_cartpoint_use'] ? ' checked' : ''; ?>>
                    ...
                    <tr class="kakao_info_fld">
                        <th scope="row">
                            ...
                            <a href="http://sir.kr/main/service/kakaopay.php?kk=yc5" target="_blank" class="kakao_btn">카카오페이
                                서비스신청하기</a>
                        </th>
                        <td>
                            ...
                            <span class="sitecode">SIRK</span> <input type="text" name="de_kakaopay_mid"
                                                                      ...
                                                                      id="de_kakaopay_mid" class="frm_input code_input"
                                                                      size="10" maxlength="7">
                        </td>
                    </tr>
                    <tr class="kakao_info_fld">
                    ...
                    <tr class="kakao_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_kakaopay_enckey" value="1"
                                   id="de_kakaopay_enckey"<?php echo $default['de_kakaopay_enckey'] ? ' checked' : ''; ?>>
                            <label for="de_kakaopay_enckey">사용</label>
                        </td>
                    </tr>
                    ...
                    <tr class="pg_info_fld nicepay_info_fld">
                        ...
                        <td>
                            ...
                            <input type="checkbox" id="de_easy_nicepay_samsungpay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_samsungpay" disabled>삼성페이</label><br>
                            <input type="checkbox" id="de_easy_nicepay_naverpay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_naverpay">NAVERPAY (네이버페이)</label><br>
                            <input type="checkbox" id="de_easy_nicepay_kakaopay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_kakaopay">KAKAOPAY (카카오페이)</label><br>
                            <input type="checkbox" id="de_easy_nicepay_applepay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_applepay">APPLEPAY (애플페이)</label><br>
                            <input type="checkbox" id="de_easy_nicepay_paycopay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_paycopay">페이코</label><br>
                            <input type="checkbox" id="de_easy_nicepay_skpay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_skpay">SK페이</label><br>
                            <input type="checkbox" id="de_easy_nicepay_ssgpay" name="de_easy_pays[]"
                                ...
                                echo 'checked="checked"';
                            } ?> > <label for="de_easy_nicepay_ssgpay">SSG페이</label><br>
                            <input type="checkbox" id="de_easy_nicepay_lpay" name="de_easy_pays[]"
                                   value="nicepay_lpay" <?php if (stripos($default['de_easy_pay_services'], 'nicepay_lpay') !== false) {
                                echo 'checked="checked"';
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" name="de_escrow_use"
                                   value="0" <?php echo $default['de_escrow_use'] == 0 ? "checked" : ""; ?>
                                   id="de_escrow_use1">
                            <label for="de_escrow_use1">일반결제 사용</label>
                            <input type="radio" name="de_escrow_use"
                                   value="1" <?php echo $default['de_escrow_use'] == 1 ? "checked" : ""; ?>
                                   id="de_escrow_use2">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" name="de_card_test"
                                   value="0" <?php echo $default['de_card_test'] == 0 ? "checked" : ""; ?>
                                   id="de_card_test1">
                            <label for="de_card_test1">실결제 </label>
                            <input type="radio" name="de_card_test"
                                   value="1" <?php echo $default['de_card_test'] == 1 ? "checked" : ""; ?>
                                   id="de_card_test2">
                            ...
                            <div class="scf_cardtest lg_cardtest">
                                ...
                                <a href="https://pgweb.tosspayments.com/tmert" target="_blank" class="btn_frmline">테스트
                                    관리자</a>
                            </div>
                            ...
                            <div id="scf_cardtest_tip">
                                ...
                                <ul id="kcp_cardtest_tip" class="scf_cardtest_tip_adm scf_cardtest_tip_adm_hide">
                                    <li>테스트결제의 <a href="http://testadmin8.kcp.co.kr/assist/login.LoginAction.do"
                                                  target="_blank">상점관리자</a> 로그인 정보는 NHN KCP로 문의하시기 바랍니다. (기술지원
                                        1544-8661)
                                    </li>
                                ...
                                <ul id="lg_cardtest_tip" class="scf_cardtest_tip_adm scf_cardtest_tip_adm_hide">
                                    <li>테스트결제의 <a href="https://pgweb.tosspayments.com/tmert" target="_blank">상점관리자</a>
                                        로그인 정보는 토스페이먼츠 상점아이디 첫 글자에 t를 추가해서 로그인하시기 바랍니다. 예) tsi_lguplus
                                    </li>
                                </ul>
                                <ul id="toss_cardtest_tip" class="scf_cardtest_tip_adm scf_cardtest_tip_adm_hide">
                                    <li>테스트 결제 시 <a href="https://app.tosspayments.com/" target="_blank">상점관리자</a> 로그인
                                        정보는 실결제용 키와는 다르니 반드시 <b>[테스트] API 연동 키</b>로 로그인해야 합니다. 예) test_ck_toss
                                    </li>
                                </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_tax_flag_use" value="1"
                                   id="de_tax_flag_use"<?php echo $default['de_tax_flag_use'] ? ' checked' : ''; ?>> 사용
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_rel_list_use" value="1"
                                   id="de_rel_list_use" <?php echo $default['de_rel_list_use'] ? "checked" : ""; ?>>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_mobile_rel_list_use" value="1"
                                   id="de_mobile_rel_list_use" <?php echo $default['de_mobile_rel_list_use'] ? "checked" : ""; ?>>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="de_simg_width"
                                   value="<?php echo get_sanitize_input($default['de_simg_width']); ?>"
                                   id="de_simg_width" class="frm_input" size="5"> 픽셀
                            /
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="de_mimg_width"
                                   value="<?php echo get_sanitize_input($default['de_mimg_width']); ?>"
                                   id="de_mimg_width" class="frm_input" size="5"> 픽셀
                            /
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="de_guest_cart_use" value="1"
                                   id="de_guest_cart_use"<?php echo $default['de_guest_cart_use'] ? ' checked' : ''; ?>>
                            사용
                        </td>
                    </tr>
                    <tr>
                ...
                <div id="scf_sms">
                    ...
                    for ($i = 1; $i <= 5; $i++) {
                        ...
                        <section class="scf_sms_box">
                            ...
                            <input type="checkbox" name="de_sms_use<?php echo $i; ?>" value="1"
                                   id="de_sms_use<?php echo $i; ?>" <?php echo($default["de_sms_use" . $i] ? " checked" : ""); ?>>
