...
?>
    ...
    <div class="local_ov01 local_ov">
        <?php echo $listall; ?>
        <span class="btn_ov01"><span class="ov_txt">전체 이벤트</span><span
    ...
    <form name="fitemeventlistupdate" method="post" action="./itemeventlistupdate.php"
          onsubmit="return fitemeventlistupdatecheck(this)">
        <input type="hidden" name="ev_id" value="<?php echo $ev_id; ?>">
        ...
        <div class="tbl_head01 tbl_wrap">
            <table>
                ...
                <tr>
                    <th scope="col">이벤트</th>
                    <th scope="col"><a
                                href="<?php echo title_sort("a.it_id") . '&amp;' . $qstr1 . '&amp;ev_id=' . $ev_id; ?>">상품코드</a>
                    </th>
                    <th scope="col"><a
                                href="<?php echo title_sort("it_name") . '&&amp;' . $qstr1 . '&amp;ev_id=' . $ev_id; ?>">상품명</a>
                    </th>
                </tr>
                </thead>
                <tbody>
                  ...
                  where it_id = '{$row['it_id']}'
                    ...
                    <tr class="<?php echo $bg; ?>">
                        <td class="td_chk2">
                            ...
                            <input type="checkbox" name="ev_chk[<?php echo $i; ?>]" value="1"
                                   id="ev_chk_<?php echo $i; ?>" <?php echo($row['ev_id'] ? "checked" : ""); ?>>
                        </td>
