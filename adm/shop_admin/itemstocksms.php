...
?>
    ...
    <div class="local_ov01 local_ov">
        ...
        <span class="btn_ov01"><span class="ov_txt">미전송 </span><span
                    class="ov_num"><?php echo number_format($unsend_count); ?>건</span></span>
    </div>
    ...
    <form name="fitemstocksms" action="./itemstocksmsupdate.php" method="post"
          onsubmit="return fitemstocksms_submit(this);">
        ...
        <div class="btn_fixed_top">
            <?php if ($is_admin == 'super') { ?>
                <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value"
                       class="btn btn_02">
            <?php } ?>
            <input type="submit" name="act_button" value="선택SMS전송" class="btn_submit btn"
