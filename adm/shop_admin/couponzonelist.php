...
?>
    ...
    <form name="fcouponlist" id="fcouponzonelist" method="post" action="./couponzonelist_delete.php"
          onsubmit="return fcouponzonelist_submit(this);">
            ...
            <table>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <tr class="<?php echo $bg; ?>">
                        <td class="td_chk">
                            <input type="hidden" id="cz_id_<?php echo $i; ?>" name="cz_id[<?php echo $i; ?>]"
                                   value="<?php echo $row['cz_id']; ?>">
                        ...
                        <td class="td_datetime"><?php echo substr($row['cz_start'], 2, 8); ?>
                            ~ <?php echo substr($row['cz_end'], 2, 8); ?></td>
                        <td class="td_mng td_mng_s">
                            <a href="./couponzoneform.php?w=u&amp;cz_id=<?php echo $row['cz_id']; ?>&amp;<?php echo $qstr; ?>"
                               class="btn btn_03"><span
                                        class="sound_only"><?php echo get_text($row['cz_subject']); ?> </span>수정</a>
                        </td>
                    </tr>
