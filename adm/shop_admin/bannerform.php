            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="bn_url" size="80"
                               value="<?php echo get_sanitize_input($bn['bn_url']); ?>" id="bn_url" class="frm_input">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <select name="bn_device" id="bn_device">
                            <option value="both"<?php echo get_selected($bn['bn_device'], 'both', true); ?>>PC와 모바일
                            </option>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="bn_begin_time" value="<?php echo $bn['bn_begin_time']; ?>"
                               id="bn_begin_time" class="frm_input" size="21" maxlength="19">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="bn_end_chk"
                               value="<?php echo date("Y-m-d 23:59:59", time() + 60 * 60 * 24 * 31); ?>" id="bn_end_chk"
