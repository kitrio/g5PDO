        ...
        <table>
            ...
            while ($res = sql_fetch_array($qry)) {
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td class="td_mbname"><a
                                href="./num_book_write.php?w=u&amp;bk_no=<?php echo $res['bk_no']; ?>"><?php echo $res['hs_name']; ?></a>
                    </td>
                    ...
                    <td class="td_left"><span
                                title="<?php echo $write['wr_message'] ?>"><?php echo $write['wr_message'] ?></span>
                    </td>
