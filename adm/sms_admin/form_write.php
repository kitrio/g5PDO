        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="fo_name" id="fo_name" required
                               value="<?php echo get_sanitize_input($write['fo_name']); ?>" class="frm_input required"
                               size="70"></td>
                </tr>
                <tr>
                    <th scope="row">메세지</th>
                    <td id="sms5_emo_add">
                        <div class="sms5_box write_wrap">
                            ...
                            <textarea name="fo_content" id="sms_contents" class="box_txt box_square"
                                      onkeyup="byte_check('sms_contents', 'sms_bytes');"
                                      accesskey="m"><?php echo html_purifier($write['fo_content']); ?></textarea>
                            ...
                            <div id="write_emo" class="write_scemo">
                                <span class="scemo_ico"></span>
                                <div class="scemo_list">
                                    <button type="button" class="scemo_add" onclick="javascript:add('*^^*')">*^^*
                                    </button>
                                    <button type="button" class="scemo_add" onclick="javascript:add('♡.♡')">♡.♡</button>
                                    ...
                                    <button type="button" class="scemo_add" onclick="javascript:add('^_~♥')">^_~♥
                                    </button>
                                    ...
                                    <button type="button" class="scemo_add emo_long"
