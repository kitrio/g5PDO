...
?>
    ...
    <form name="search_form" id="search_form" action=<?php echo $_SERVER['SCRIPT_NAME']; ?> class="local_sch01
          local_sch" method="get">
        ...
        <table>
            ...
            while ($res = sql_fetch_array($qry)) {
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td class="td_left"><span
                                title="<?php echo $res['wr_message'] ?>"><?php echo $res['wr_message'] ?></span></td>
                    ...
                    <td class="td_mng td_mng_s">
                        <a href="./history_view.php?page=<?php echo $page; ?>&amp;st=<?php echo $st; ?>&amp;sv=<?php echo $sv; ?>&amp;wr_no=<?php echo $res['wr_no']; ?>"
