...
?>
    ...
    <form name="book_form" id="book_form" method="post" action="./num_book_update.php">
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select name="bg_no" id="bg_no" required class="required">
                            <option value="1"><?php echo $no_group['bg_name'] ?>
                            ...
                            while ($res = sql_fetch_array($qry)) {
                                ?>
                                <option value="<?php echo $res['bg_no'] ?>" <?php echo $res['bg_no'] == $write['bg_no'] ? 'selected' : '' ?>> <?php echo $res['bg_name'] ?>
                                    (<?php echo number_format($res['bg_count']) ?> 명)
                                </option>
                            <?php } ?>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="bk_name" id="bk_name" maxlength="50"
                               value="<?php echo get_sanitize_input($write['bk_name']); ?>" required
                            ...
                            <div id="hp_check_el">
                                <ul>
                                    ...
                                    foreach ($exist_hplist as $v) {
                                        ...
                                        ?>
                                        <li><strong>중복됨 </strong><a href="<?php echo $href; ?>"
                                                                    target="_blank"><?php echo $v['mb_id']; ?></a></li>
                                        <?php
                                    }
                                    ?>
                                </ul>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="bk_receipt" id="bk_receipt_1"
                               value="1" <?php echo $write['bk_receipt'] ? 'checked' : '' ?>>
                        <label for="bk_receipt_1">수신허용</label>
                        <input type="radio" name="bk_receipt" id="bk_receipt_2"
                               value="0" <?php echo !$write['bk_receipt'] ? 'checked' : '' ?>>
        ...
        <div class="btn_fixed_top">
            ...
            <a href="./num_book.php?<?php echo clean_query_string($_SERVER['QUERY_STRING']); ?>"
               class="btn btn_02">목록</a>
        </div>
