...
?>
    ...
    <div id="sms5_sent">
        <div class="local_ov01 local_ov">
            <span class="btn_ov01"><span class="ov_txt">전송건수</span><span
                        class="ov_num"> <?php echo number_format($write['wr_total']) ?> 건</span></span>
            <span class="btn_ov01"><span class="ov_txt">성공건수 </span><span
                        class="ov_num"><?php echo number_format($write['wr_success']) ?> 건</span></span>
            <span class="btn_ov01"><span class="ov_txt">실패건수 </span><span
                        class="ov_num"><?php echo number_format($write['wr_failure']) ?> 건</span></span>
            <span class="btn_ov01"><span class="ov_txt">전송일시 </span><span
                        class="ov_num"><?php echo $write['wr_datetime'] ?></span></span>
            <span class="btn_ov01"><span class="ov_txt">예약일시 </span><span
                        class="ov_num"><?php echo $write['wr_booking'] ?></span></span>
            <span class="btn_ov01"><span class="ov_txt">회신번호 </span><span
                        class="ov_num"><?php echo $write['wr_reply'] ?></span></span>
        </div>
                ...
                <table>
                    ...
                    while ($res = sql_fetch_array($qry)) {
                        ...
                        <tr>
                            ...
                            <td class="td_mng">
                                <a href="./history_view.php?page=<?php echo $page ?>&amp;st=<?php echo $st ?>&amp;sv=<?php echo $sv ?>&amp;wr_no=<?php echo $res['wr_no'] ?>&amp;wr_renum=<?php echo $res['wr_renum'] ?>"
                ...
                while ($res = sql_fetch_array($qry)) {
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="td_mng td_mng_s">
                            <?php if ($res['bk_no']) { ?>
                                <a href="./history_num.php?wr_id=<?php echo $res['wr_no'] ?>&amp;st=bk_no&amp;sv=<?php echo $res['bk_no'] ?>"
                                   class="btn_03 btn">내역</a>
                            <?php } else { ?>
                                <a href="./history_num.php?wr_id=<?php echo $res['wr_no'] ?>&amp;st=hs_hp&amp;sv=<?php echo $res['hs_hp'] ?>"
                                   class="btn_03 btn">내역</a>
                            <?php } ?>
                        </td>
                    </tr>
