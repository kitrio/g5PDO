        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="gr_id" value="<?php echo $group['gr_id'] ?>"
                               id="gr_id" <?php echo $gr_id_attr; ?> class="<?php echo $gr_id_attr; ?> alnum_ frm_input"
                               maxlength="10">
                        <?php
                        if ($w == '') {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="gr_subject" value="<?php echo get_text($group['gr_subject']) ?>"
                               id="gr_subject" required class="required frm_input" size="80">
                        <?php
                        if ($w == 'u') {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select id="gr_device" name="gr_device">
                            <option value="both" <?php echo get_selected($group['gr_device'], 'both', true); ?>>PC와
                                모바일에서 모두 사용
                            </option>
                            <option value="pc" <?php echo get_selected($group['gr_device'], 'pc'); ?>>PC 전용</option>
                            <option value="mobile" <?php echo get_selected($group['gr_device'], 'mobile'); ?>>모바일 전용
                            </option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="gr_use_access" value="1"
                               id="gr_use_access" <?php echo $gr['gr_use_access'] ? 'checked' : ''; ?>>
                        사용
                    </td>
                </tr>
                <tr>
                ...
                <?php for ($i = 1; $i <= 10; $i++) { ?>
                    <tr>
                        ...
                        <td class="td_extra">
                            ...
                            <input type="text" name="gr_<?php echo $i ?>_subj"
                                   value="<?php echo isset($group['gr_' . $i . '_subj']) ? get_text($group['gr_' . $i . '_subj']) : ''; ?>"
                                   id="gr_<?php echo $i ?>_subj" class="frm_input">
                            <label for="gr_<?php echo $i ?>">여분필드 <?php echo $i ?> 내용</label>
                            <input type="text" name="gr_<?php echo $i ?>"
                                   value="<?php echo isset($gr['gr_' . $i]) ? get_sanitize_input($gr['gr_' . $i]) : ''; ?>"
                                   id="gr_<?php echo $i ?>" class="frm_input">
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
