...
?>
    ...
    <form name="fmailform" id="fmailform" action="./mail_update.php" onsubmit="return fmailform_check(this);"
          method="post">
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="ma_subject"
                               value="<?php echo get_sanitize_input($ma['ma_subject']); ?>" id="ma_subject" required
                               class="required frm_input" size="100"></td>
                </tr>
                <tr>
