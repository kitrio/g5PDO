    ...
    <section class="pesonal sod_left"><!-- id="sod_frm_pay" -->
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    <td><input type="text" name="pp_name" value="<?php echo get_text($pp['pp_name']); ?>" id="pp_name"
                               required class="required frm_input"></td>
                    <td><input type="text" name="pp_hp" value="<?php echo get_text($member['mb_hp']); ?>" id="pp_hp"
                               required class="required frm_input"></td>
                </tr>
                <tr>
                    <th scope="col" colspan="2"><label for="pp_email">이메일<strong class="sound_only"> 필수</strong></label>
                    </th>
                </tr>
                <tr>
                    <td colspan="2"><input type="text" name="pp_email" value="<?php echo $member['mb_email']; ?>"
                                           id="pp_email" required class="required frm_input" size="30"></td>
                </tr>
                </tbody>
            </table>
        </div>
