...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <p style="<?php echo $cont_st; ?>">배송지를 변경하실 고객님은 <b><?php echo $default['de_admin_company_tel']; ?></b>로 연락주시기
            바랍니다.</p>

        <a href="<?php echo G5_SHOP_URL . '/orderinquiry.php'; ?>" target="_blank" style="<?php echo $ft_a_st; ?>">주문상세내역
            확인</a>
