    ...
    <div style="border:1px solid #dedede">
        ...
        <table style="<?php echo $cont_st; ?>">
            ...
            <tr>
                ...
                <td style="<?php echo $td_st; ?>"><a href="<?php echo shop_item_url($list[$i]['it_id']); ?>"
                                                     target="_blank" style="text-decoration:none"><span
                                style="display:inline-block;vertical-align:middle"><?php echo $list[$i]['it_simg']; ?></span> <?php echo $list[$i]['it_name']; ?>
                    </a></td>
            </tr>
            <tr>
        ...
        <table style="<?php echo $cont_st; ?>">
            ...
            <?php if ($od_hope_date) { ?>
                <tr>
                    ...
                    <td style="<?php echo $td_st; ?>"><?php echo $od_hope_date; ?>
                        (<?php echo get_yoil($od_hope_date); ?>)
                    </td>
                </tr>
            <?php } ?>
            </tbody>
        ...
        <p style="<?php echo $cont_st; ?>">이 주문과 관련된 내용은 <b><?php echo $default['de_admin_company_tel']; ?></b>로 연락주시기
            바랍니다.</p>

        <a href="<?php echo G5_SHOP_URL . '/'; ?>" target="_blank"
           style="<?php echo $ft_a_st; ?>"><?php echo $config['cf_title']; ?></a>
