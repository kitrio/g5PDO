...
?>
<div id="category">
    <button type="button" class="close_btn"><i class="fa fa-times" aria-hidden="true"></i> 카테고리<span class="sound_only">닫기</span>
    </button>
    ...
    <div class="ct_wr">
        ...
        for ($i = 0; $mshop_ca_row1 = sql_fetch_array($mshop_ca_res1); $i++) {
            ...
            ?>
            <li class="cate_li_1">
            <a href="<?php echo shop_category_url($mshop_ca_row1['ca_id']); ?>"
