...
<div id="sc_coupon_frm" class="od_coupon">
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <tr>
                        ...
                        <td class="td_mngsmall">
                            <button type="button" class="sc_cp_apply btn_frmline">적용</button>
                        </td>
                    </tr>
                    <?php
                }
    ...
    <div class="btn_confirm">
        <button type="button" id="sc_coupon_close" class="btn_close"><i class="fa fa-times" aria-hidden="true"></i><span
