                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($pp['pp_cash']) {
                                            ...
                                            ?>
                                            <a href="javascript:;"
                                               onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?tx=personalpay&od_id=<?php echo $pp_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');"
                ...
                <form method="post" action="http://devadmin.kcp.co.kr/Modules/Noti/TEST_Vcnt_Noti_Proc.jsp"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="e_trade_no" value="<?php echo $pp['pp_tno']; ?>" size="80">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="req_name" value="<?php echo $pp['pp_deposit_name']; ?>"
                                       size="80"></td>
                        </tr>
                        <tr>
                            <th scope="col"><label for="noti_url">입금통보 URL</label></th>
                            <td><input type="text" name="noti_url"
                                       value="<?php echo G5_SHOP_URL; ?>/settle_kcp_common.php" size="80"></td>
                        </tr>
                        </tbody>
                    </table>
