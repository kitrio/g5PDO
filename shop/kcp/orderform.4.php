...
<section id="sod_frm_escrow">
    ...
    <table>
        <tr>
            <td>
                <a href="http://admin.kcp.co.kr/Modules/escrow/kcp_pop.jsp?site_cd=<?php echo $default['de_kcp_mid']; ?>"
                   class="nhnkcp_escrow_popup" data-sitecd="<?php echo $default['de_kcp_mid']; ?>" target="_blank"><img
                            src="<?php echo G5_SHOP_URL; ?>/img/marks_escrow/escrow_foot.gif" width="290" height="92"
                            border="0" usemap="#Map"></a></td>
        </tr>
        <tr>
            <td>
                <strong>에스크로(escrow) 제도란?</strong>
                <p>
                    상거래 시에, 판매자와 구매자의 사이에 신뢰할 수 있는 중립적인 제삼자(여기서는 <a href='http://kcp.co.kr' target='_blank'>KCP</a>)가
                    중개하여
...
<!-- <?php if ($default['de_card_use'] || $default['de_iche_use']) {
    echo "결제대행사 : KCP";
} ?> -->