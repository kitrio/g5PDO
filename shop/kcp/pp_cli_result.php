                ...
                if (!$bSucc == "false")                    // 업체 DB 처리 정상
                {
                    if ($res_cd == "0000")                 // 정상 승인
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" name="receiptView" class="btn_frmline"
                                        onClick="javascript:receiptView('<?php echo $receipt_no; ?>')">영수증 확인
                                </button>
            ...
            } else if ($req_tx == "mod")                     // 거래 구분 : 조회/취소 요청
            {
                if ($res_cd == "0000") {
                    ...
                    <tr>
                        <th scope="row">현금영수증 URL</th>
                        <td>
                            <input type="button" name="receiptView" value="영수증 확인" class="box"
                                   onClick="javascript:receiptView('<?php echo $receipt_no; ?>')">
                            <p>영수증 확인은 실 등록의 경우에만 가능합니다.</p>
                        </td>
                    </tr>
                    <?php
